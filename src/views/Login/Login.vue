        ...
        <form @submit.prevent="login">
          ...
          <div :class="{ on:!loginWay }">
            <section>
              ...
              <section class="login_verification">
                <input type="password" maxlength="8" placeholder="密码" v-model="pwd" v-show="!pwdShow" >
                <input type="text" maxlength="8" placeholder="密码" v-model="pwd" v-show="pwdShow">
                <div class="switch_button" :class="pwdShow?'on':'off'" @click="pwdShow = !pwdShow">
                  <div class="switch_circle" :class="pwdShow?'right':''"></div>
